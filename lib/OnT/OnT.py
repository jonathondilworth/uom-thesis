...
class OntologyTransformer(nn.Module):
    ...
    def encode_concept(self, concept_sentences, *args, **kwargs):
        concept_embed = self.hit_model.encode(concept_sentences, *args, **kwargs)
        return concept_embed
    
    def encode_roles(self, role_sentences, *args, **kwargs):
        role_embed = self.role_model(
            self.hit_model.encode(role_sentences, *args, **kwargs)
        )
